 ...
 ** File	:	C:/Users/zhang/Desktop/work/FPGA/PH1/Verimake_camera_mipi_ddr_hdmi/user_source/ip_source/w96_d512_24_softfifo.v
 ** Date	:	2023 09 07
...
module w96_d512_24_softfifo #(parameter DATA_WIDTH_W = 96, 
    ...
    fifo_cross_domain_addr_process_al_w96_d512_24_softfifo #(.ADDR_WIDTH(ADDR_WIDTH_R)) rd_to_wr_cross_inst (.primary_asreset_i(rd_rst), 
    ...
    fifo_cross_domain_addr_process_al_w96_d512_24_softfifo #(.ADDR_WIDTH(ADDR_WIDTH_W)) wr_to_rd_cross_inst (.primary_asreset_i(wr_rst), 
                .secondary_asreset_i(rd_rst), 
                .primary_clk_i(clkw), 
                .secondary_clk_i(clkr), 
                .primary_addr_i(wr_addr), 
                .secondary_addr_o(wr_to_rd_addr)) ; 
    ram_infer_w96_d512_24_softfifo #(.DATAWIDTH_A(DATA_WIDTH_W),
...
// ===========================================================================
module fifo_cross_domain_addr_process_al_w96_d512_24_softfifo #(parameter ADDR_WIDTH = 9) (
...
// ===========================================================================
module ram_infer_w96_d512_24_softfifo (clka, 
        rsta, 
        cea, 
        ocea, 
        wea, 
    ...
    reg [(MIN_WIDTH - 1):0] memory [(MAX_DEPTH - 1):0] ;  /* fehdl force_ram=1, ram_style="bram_fast" */ 
