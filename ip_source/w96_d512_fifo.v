 ...
 ** File	:	C:/Users/zhang/Desktop/work/FPGA/PH1/Verimake_camera_mipi_ddr_hdmi_2/user_source/ip_source/w96_d512_fifo.v
 ** Date	:	2023 09 17
...
module w96_d512_fifo #(parameter DATA_WIDTH_W = 96, 
        parameter DATA_WIDTH_R = 96, 
    ...
    fifo_cross_domain_addr_process_al_w96_d512_fifo #(.ADDR_WIDTH(ADDR_WIDTH_R)) rd_to_wr_cross_inst (.primary_asreset_i(rd_rst), 
    ...
    fifo_cross_domain_addr_process_al_w96_d512_fifo #(.ADDR_WIDTH(ADDR_WIDTH_W)) wr_to_rd_cross_inst (.primary_asreset_i(wr_rst), 
                .secondary_asreset_i(rd_rst), 
                .primary_clk_i(clkw), 
                .secondary_clk_i(clkr), 
                .primary_addr_i(wr_addr), 
                .secondary_addr_o(wr_to_rd_addr)) ; 
    ram_infer_w96_d512_fifo #(.DATAWIDTH_A(DATA_WIDTH_W),
...
// ===========================================================================
module fifo_cross_domain_addr_process_al_w96_d512_fifo #(parameter ADDR_WIDTH = 9) (
...
// ===========================================================================
module ram_infer_w96_d512_fifo (clka, 
        rsta, 
        cea, 
        ocea, 
        wea, 
